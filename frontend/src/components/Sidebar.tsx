    ...
    >
      ...
      <div className="flex flex-col flex-1 p-3 lg:p-4 space-y-1 lg:space-y-2 overflow-y-auto">
        ...
        <NavItem
          icon={
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 lg:w-6 lg:h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 111.06 1.06L16.81 11.5h2.69c.414 0 .75.336.75.75v2.69l4.72-4.72a.75.75 0 111.06 1.06l-6 6a.75.75 0 11-1.06 0l-6-6a.75.75 0 111.06-1.06l4.72 4.72V12a.75.75 0 01.75-.75h2.69l-4.72-4.72a.75.75 0 010-1.06z" />
            </svg>
          }
          label="Video Analyzer"
          isActive={currentView === 'video-analyzer'}
          isOpen={isOpen}
          onClick={() => setCurrentView('video-analyzer')}
          setIsSidebarOpen={setIsSidebarOpen}
        />
        <NavItem
          icon={
          ...
          label="Live Monitor"
          isActive={currentView === 'live-monitor'}
          isOpen={isOpen}
